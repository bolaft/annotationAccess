...
public class ConstrainedIteratorExampleAnnotator extends JCasAnnotator_ImplBase {
	...
	private FSMatchConstraint buildANounOrVerbTypeConstraint(JCas aJCas) {
		...
		FSTypeConstraint properNounConstraint = cf.createTypeConstraint();
		properNounConstraint.add(aJCas.getTypeSystem().getType("common.types.pos.NP"));
		...
		FSMatchConstraint finalConstraint = cf.or(nounOrVerbConstraint, properNounConstraint);
